  ...
  return (
    <div className=" mt-16 fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50 z-30">
     <div className="mt-2 bg-white w-3/4 max-h-full overflow-y-auto rounded-lg">
        ...
        <section class={`py-8 md:py-16 dark:bg-gray-900 antialiased ${scrollable ? 'overflow-y-auto' : ''}`} ref={scrollContainerRef}>
        ...
        <div class="mt-6 sm:mt-8 lg:mt-0">
          ...
          <div class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
            ...
            <button
              ...
              class="text-white mt-4 sm:mt-0 bg-blue-800 hover:bg-blue-500 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800 flex items-center justify-center"
