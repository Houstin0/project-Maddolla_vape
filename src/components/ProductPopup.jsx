  ...
  return (
    <div className="mt-14 py-2 fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50 z-30">
      <div className="relative bg-gray-100 dark:bg-gray-900 w-full mx-5 md:mx-0 md:w-5/6 max-h-full rounded-lg overflow-y-auto hide-scrollbar">
        ...
        <button
          className="absolute top-0 right-0 p-3 z-auto "
          onClick={onClose}
          aria-label="Close"
        >
              ...
              <div className="mt-6 sm:mt-8 lg:mt-0">
                ...
                <div className="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                  <button
                    ...
                    className="text-white mt-4 sm:mt-0 bg-[#0A005A] hover:bg-[#FC411E]   font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 flex items-center justify-center"
                  >
