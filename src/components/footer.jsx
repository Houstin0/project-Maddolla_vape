...
<footer className="bg-white rounded-lg shadow dark:bg-gray-900 m-4">
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
            <a href="/" className="italic text-black text-2xl font-extrabold dark:text-white flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
            Madolla vape
            </a>
            <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
      <li>
        <NavLink to="/about" onClick={scrollToTop} className="hover:underline me-4 md:me-6">
          About Us
        </NavLink>
      </li>
      <li>
      ...
      <li>
        ...
        <span id="currentYear" className="block text-sm text-gray-500 sm:text-center dark:text-gray-400"> </span>
    </div>
</footer>
