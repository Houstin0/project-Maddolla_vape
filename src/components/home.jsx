...
export default function Home() {
  return (
    <main>
      <section
        className="bg-center bg-no-repeat bg-contain bg-gray-700 bg-blend-multiply mt-10 py-16 lg:py-20"
        style={{ 
      ...
      >
        <div className="px-4 mx-auto max-w-screen-xl text-center py-8 lg:py-12"> 
          ...
          <p className="mb-8 text-lg font-normal text-gray-400 lg:text-xl sm:px-6"> 
